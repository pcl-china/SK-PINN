...
class PhysicsInformedNN():
    # 初始化
    def __init__(self, x_area, x_bc,U_bc,Re,
    ...
    def Calculate_loss(self):
        ...
        loss = 1 * loss_ubc + 1 * loss_vbc + 1 * loss_fe1 + 1 * loss_fe2 + 1 * loss_fe3
        self.iter += 1
...
Adam_iter = 200
LBFGS_iter = 400
model = PhysicsInformedNN(x_area,x_bc,u_bc,Re,
                 layers,layers_u,layers_v,layers_p,ub,lb,Adam_iter,LBFGS_iter)
